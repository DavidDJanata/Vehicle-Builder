...
class Motorbike extends Vehicle {
  ...
  // !Done!Create a constructor that accepts the properties of the Motorbike class
    // !DoneThe constructor should call the constructor of the parent class, Vehicle
    // !DoneThe constructor should initialize the properties of the Motorbike class
